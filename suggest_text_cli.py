...
def process_one(
    *,
    ...
    # local validation (helpful even in dry-run)
    try:
    ...
    # Ensure FK integrity for ai_text_suggestions
    ...
    try:
        ...
        # Prefer title text in summary if present
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    # Build OutputSpec (snake_case; mapped later)
